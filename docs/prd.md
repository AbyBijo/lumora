...
9. **User auth** — register/login with bcrypt-hashed passwords, revocable
   server-side sessions, rate limiting, CSRF protection.
...
| FR-7 | Auth | Register/login/logout; bcrypt; revocable sessions; rate-limited; CSRF-safe |
