...
| [api.md](api.md) | API conventions — how to add an endpoint |
| [security.md](security.md) | Auth model, sessions, CSRF, rate limiting, headers |
...
- [0005 — Local demo session (superseded)](adr/0005-auth.md)
...
- [0008 — Real authentication (replaces demo sessions)](adr/0008-auth.md)
- [0009 — Standardized API layers](adr/0009-api-layers.md)
